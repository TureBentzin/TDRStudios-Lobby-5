...
public class UsageMessage extends Message{
    ...
    public UsageMessage(Command command) {
        super("tdrstudios.usage.invalid." + command.getName(), Chat.getErrorColor() + "Please care about the usage :\"" + Chat.getAccentColor() + command.getUsage().replace("<command>", command.getName()) + Chat.getErrorColor() + "\"!");
